...
import type { PlayerCell, GameState } from './types';
...
export function calculateCenterOfMass(cells: PlayerCell[]): { x: number; y: number } {
...
export function findSafeSpawnLocation(gameState: GameState, minDistance: number = 100): { x: number; y: number } {
